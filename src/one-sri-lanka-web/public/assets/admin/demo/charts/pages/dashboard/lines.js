...
var DashboardLines = (function () {
    ...
    var _AppSalesLinesChart = function (element, height) {
        ...
        if (element) {
            ...
            d3.csv(
                "../../../assets/admin/demo/data/dashboard/app_sales.csv",
                function (error, data) {
                    formatted = data;
                    redraw();
                }
            ...
            function redraw() {
                ...
                var sidebarToggle =
                    document.querySelectorAll(".sidebar-control");
                if (sidebarToggle) {
    ...
    return {
        init: function () {
            ...
            document.querySelectorAll(".chart-line").forEach(function (el) {
                _DailyRevenueLineChart(el, 50); // pass element instead of ID
            });
        },
    };
})();
