    ...
    <div class="content">
                    ...
                    <div class="col-lg-3">
                        <div class="card bg-danger text-white">
                            <div class="card-body">
                                ...
                                <div>
                                    Total Complaints
                                    <div class="fs-sm opacity-75">+120 this week</div>
                                </div>
                            </div>
                            <div class="rounded-bottom overflow-hidden" id="complaints-total"></div>
                        </div>
                    </div>
                    <!-- /Total Complaints -->
                    ...
                    <div class="col-lg-3">
                        <div class="card bg-warning text-white">
                            <div class="card-body">
                                ...
                                <div>
                                    Pending Complaints
                                    <div class="fs-sm opacity-75">30 urgent</div>
                                </div>
                            </div>
                            <div class="rounded-bottom overflow-hidden" id="complaints-pending"></div>
                        </div>
                    </div>
                    <!-- /Pending Complaints -->
                    ...
                    <div class="col-lg-3">
                        <div class="card bg-success text-white">
                            <div class="card-body">
                                ...
                                <div>
                                    Resolved Complaints
                                    <div class="fs-sm opacity-75">78% success rate</div>
                                </div>
                            </div>
                            <div class="rounded-bottom overflow-hidden" id="complaints-resolved"></div>
                        </div>
                    </div>
                    <!-- /Resolved Complaints -->
                        ...
                        <div class="card bg-secondary text-white">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="fs-sm opacity-75">Users stopped midway</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                        <h5 class="py-sm-2 my-sm-1">Complaints by Category</h5>
                        <div class="mt-2 mt-sm-0 ms-sm-auto">
                            <select class="form-select" id="select_date">
                                <option value="val1">June, 29 - July, 5</option>
                                <option value="val2">June, 22 - June 28</option>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                        <h5 class="py-sm-2 my-sm-1">Complaints: Submitted vs Discrad</h5>
                        <div class="mt-2 mt-sm-0 ms-sm-auto">
                            <select class="form-select" id="select_date">
                                <option value="val1">June, 29 - July, 5</option>
                                <option value="val2">June, 22 - June 28</option>
        ...
        <div class="row">
            ...
            @php
                $stats = [
                    ['title' => 'Health Complaints', 'value' => '1,250', 'avg' => '1,100 avg', 'color' => 'bg-primary'],
                    ['title' => 'Transport Issues', 'value' => '980', 'avg' => '870 avg', 'color' => 'bg-success'],
                    ['title' => 'Civil Services', 'value' => '1,540', 'avg' => '1,400 avg', 'color' => 'bg-danger'],
                    ['title' => 'Media Reports', 'value' => '760', 'avg' => '700 avg', 'color' => 'bg-warning'],
                    ['title' => 'Education Complaints', 'value' => '1,200', 'avg' => '1,050 avg', 'color' => 'bg-info'],
                    ['title' => 'Public Transport', 'value' => '1,050', 'avg' => '990 avg', 'color' => 'bg-secondary'],
                    ['title' => 'Utility Services', 'value' => '870', 'avg' => '820 avg', 'color' => 'bg-dark'],
                    ['title' => 'Others', 'value' => '640', 'avg' => '600 avg', 'color' => 'bg-teal'],
                ];
            @endphp

            @foreach($stats as $stat)
                <div class="col-lg-3 col-md-6">
                    <div class="card text-white {{ $stat['color'] }}">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                            ...
                            <div>
                                {{ $stat['title'] }}
                                <div class="fs-sm opacity-75">{{ $stat['avg'] }}</div>
                            </div>
                        </div>

                        <div class="rounded-bottom overflow-hidden chart-line">
                        </div>
                    </div>
                </div>
            @endforeach
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/facebook.svg')}}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/youtube.svg')}}"
                                                    class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/spotify.svg')}}"
                                                    class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/twitter.svg')}}"
                                                    class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/bing.svg')}}"
                                                    class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/amazon.svg')}}"
                                                    class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="{{asset('assets/admin/images/brands/dribbble.svg')}}"
                                                    class="rounded-circle" width="36" height="36" alt="">
                                            </a>
                                            <div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{asset('assets/admin/images/demo/users/face15.jpg')}}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{asset('assets/admin/images/demo/users/face8.jpg')}}"
                                                    class="rounded-circle" width="40" height="40" alt="">
                                            </a>
                                            <div>
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{asset('assets/admin/images/demo/flat/1.png')}}"
                                ...
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{asset('assets/admin/images/demo/flat/21.png')}}"
                                            class="flex-shrink-0 rounded" height="100" alt="">
                                        <div
                                            class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                            ...
                            <div class="col-xl-6">
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{asset('assets/admin/images/demo/flat/12.png')}}"
                                            class="flex-shrink-0 rounded" height="100" alt="">
                                        <div
                                            class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                ...
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="{{asset('assets/admin/images/demo/flat/18.png')}}"
                                            class="flex-shrink-0 rounded" height="100" alt="">
                                        <div
                                            class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{asset('assets/admin/images/demo/logos/1.svg')}}" alt=""
                                                    height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{asset('assets/admin/images/demo/logos/2.svg')}}" alt=""
                                                    height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{asset('assets/admin/images/demo/logos/3.svg')}}" alt=""
                                                    height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{asset('assets/admin/images/demo/logos/4.svg')}}" alt=""
                                                    height="36">
                                            </a>
                                            <div>
                ...
                {{-- <div class="card">
                    ...
                    <div class="tab-content card-body">
                        ...
                        <div class="tab-pane fade" id="messages-mon">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ asset('assets/admin/images/demo/users/face2.jpg') }}"
                                        class="rounded-circle" width="40" height="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ asset('assets/admin/images/demo/users/face7.jpg') }}"
                                        class="rounded-circle" width="40" height="40" alt="">
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ asset('assets/admin/images/demo/users/face18.jpg') }}"
                                        class="rounded-circle" width="40" height="40" alt="">
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ asset('assets/admin/images/demo/users/face14.jpg') }}"
                                        class="rounded-circle" width="40" height="40" alt="">
                                    <span class="status-indicator bg-success"></span>
                                </div>
                        ...
                        <div class="tab-pane fade" id="messages-fri">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{asset('assets/admin/images/demo/users/face15.jpg')}}" class="rounded-circle"
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{asset('assets/admin/images/demo/users/face12.jpg')}}" class="rounded-circle"
                                        width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{asset('assets/admin/images/demo/users/face22.jpg')}}" class="rounded-circle"
                                        width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{asset('assets/admin/demo/users/face24.jpg')}}" class="rounded-circle"
                                        width="40" jeight="40" alt="">
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="{{asset('assets/admin/images/demo/users/face17.jpg')}}" class="rounded-circle"
                                        width="40" jeight="40" alt="">
                                    <span class="status-indicator bg-secondary"></span>
                                </div>
...
@section('center-scripts')
    ...
    <script src="{{asset('assets/admin/js/vendor/visualization/echarts/echarts.min.js')}}"></script>
@endsection
...
@section('scripts')
    ...
    <script src="{{asset('assets/admin/demo/charts/echarts/lines/lines_zoom.js')}}"></script>
    <script src="{{asset('assets/admin/demo/charts/echarts/lines/area_zoom.js')}}"></script>
@endsection