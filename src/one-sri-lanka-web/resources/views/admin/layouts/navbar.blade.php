...
<div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10">
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="{{route('admin.dashboard')}}" class="d-inline-flex align-items-center">
                <img width="160" style="height: 50px" src="{{asset('assets/admin/images/logo.png')}}" alt="">
                {{-- <img src="{{asset('assets/admin/images/logo_text_light.svg')}}"
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-0">
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{asset('assets/admin/images/demo/logos/1.svg')}}" class="h-40px mb-2"
                                        alt="">
                        ...
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{asset('assets/admin/images/demo/logos/2.svg')}}" class="h-40px mb-2"
                                        alt="">
                        ...
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{asset('assets/admin/images/demo/logos/3.svg')}}" class="h-40px mb-2"
                                        alt="">
                        ...
                        <div class="col">
                            <button type="button"
                                ...
                                <div>
                                    <img src="{{asset('assets/admin/images/demo/logos/4.svg')}}" class="h-40px mb-2"
                                        alt="">
    ...
    ? asset('admin/images/' . auth()->user()->avatar)
    : asset('assets/admin/images/users/avatar-1.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
